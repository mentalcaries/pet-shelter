  ...
  return (
    <section className="shelter">
      <div className="shelter__details">
        <img
          src={logo}
          alt={`Logo for Pet Shelter`}
          className="shelter__logo"
        />
        ...
        <div className="shelter__buttons">
          ...
          <button className="shelter__button button__blue">
            Sponsor a Pet
          </button>
        </div>
      </div>
      ...
      <div className="shelter__links">
        <h3 className="shelter__suggestions">Animals at this shelter</h3>
        <div className="suggestions__list">
          {PetData.map((pet) => (
            <PetCard pet={pet} cardType="mini" />
          ))}
        </div>
      </div>

      <div className="shelter__links">
        <h3 className="shelter__suggestions">More shelters in the area</h3>
        <div className="suggestions__list">
